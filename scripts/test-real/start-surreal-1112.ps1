# 启动 SurrealDB 服务器（站点 1112）
# 端口: 8021

$ErrorActionPreference = "Stop"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "启动 SurrealDB 服务器 - 站点 1112" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$DataDir = Join-Path $Site1112Dir "surrealdb-data"
...
Write-Host "  端口: 8021" -ForegroundColor Gray
...
# 启动 SurrealDB（使用文件存储）
surreal start --log trace --user root --pass root file://surrealdb --bind 127.0.0.1:8021
